...
//className = "flex mt-2" style = { _quadro_table } >

const MontagensTabela = ({ dados, selects, permissoes, master }) => {
    ...
    },
    {
      ...
      renderCell: (params) => (
        <div>
          ...
          >
            <Link to={`/editaMontagem/${params.id}`}>
              <EditIcon />
            </Link>
          </IconButton>
  ...
  return (
    <React.Fragment>
      ...
      <div className="flex mt-6 justify-between">
        <h2 className="mt-4 text-center text-yellow-300">Montagens</h2>
      ...
      <Box className="flex bg-gray-300 bg-opacity-100 rounded shadow-xl mt-2"
        sx={{
          ...
          '& .super-app-theme--header': {
            backgroundColor: '#FFB52E', //'rgba(255, 7, 0, 0.55)',
          },
        }}
        style={{ height: altura }}>
        <DataGrid
...
export default MontagensTabela;
